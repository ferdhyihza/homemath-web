    ...
    <>
      <nav className="navbar bg-white py-3 sticky-top">
        <div className="container">
          {/* Toggler */}
          <button className="btn px-3 bg-darkblue" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
          ...
          {/* Offcanvas */}
          <div className="offcanvas offcanvas-start bg-darkblue" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
