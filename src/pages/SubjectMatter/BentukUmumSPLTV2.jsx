    ...
    <Main>
      ...
      <div className="row justify-content-center align-items-start mb-2">
        ...
        <div className="col-3 px-0">
          ...
          <p className="mb-0 fst-italic text-center fw-light">isikan konstanta yang diketahui</p>
        </div>
      </div>
      ...
      <div className="row justify-content-center align-items-start mb-4">
        <div className="col-3 d-flex text-center p-2 border border-2 border-blue rounded-2 fs-5 justify-content-center">
